...
func update_animation():
	...
	match state:
		...
		PlayerState.ATTACK:
			if animation_player.current_animation != "Attack" + suffix:
				animation_player.play("Attack" + suffix)
				# Usar um timer para retornar ao estado normal após a animação
...
func _on_body_entered(body):
	if body.name == "Enemy":
		...
		print("Jogadora entrou na área do espinho.")
